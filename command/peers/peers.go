...
import (
	...
	"github.com/juanidrobo/polygon-edge/command/peers/add"
	"github.com/juanidrobo/polygon-edge/command/peers/list"
	"github.com/juanidrobo/polygon-edge/command/peers/status"
